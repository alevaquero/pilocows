#ifndef _SCREEN_SCAN_H_
#define _SCREEN_SCAN_H_
...
// Called after session_create / session_set_active / session_close.
...
// Show a transient status message overlay (auto-clears after 2s).
void screen_scan_show_status(const char *msg);

// Flash the full-screen overlay green (new) or red (duplicate).
// Must be called within display_lvgl_lock()/unlock() (or LVGL task context).
